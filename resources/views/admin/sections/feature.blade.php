    ...
    <div class="container-fluid">
        <div class="row second-chart-list third-news-update">
            <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
                <div class="card-body">
                    <form method="POST" action="{{url('admin/feature-update/'.$setting->id)}}" enctype="multipart/form-data">
                        @csrf
                      ...
                      @endforeach --}}
                      <div class="mb-3">
                        <label class="col-form-label">Small Heading</label>
                        <input class="form-control" type="text" name="subheading" value="{{json_decode($setting->content)->subheading}}" required>
                      </div>   
                      <div class="mb-3">
                        <label class="col-form-label">Heading</label>
            ...
            <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
                <div class="card-body">
                  <h3>Add Card</h3>
                    <form method="POST" action="{{route('add-feature')}}" enctype="multipart/form-data">
                        @csrf
                      <div class="mb-3">
                        <label class="col-form-label">Heading</label>
                    ...
                    <form method="POST" action="{{route('add-feature')}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <br>
                                <input id="imageUpload" type="file" name="icon" placeholder="Photo" capture="" value="" required>
                            </div>
                        </div>
                      <div class="mb-3">
                        <label class="col-form-label">Heading</label>
        ...
        <div class="row">
                    ...
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <tr>
                            ...
                            <form id="delete-form" action="{{url('admin/delete-feature-sub/'.$sec->id)}}" method="post">
                            @csrf
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="secondTable">
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th>Icon</th>
                        ...
                        <tbody>
                         @foreach ($feature_second as $sec)
                        <tr>
                            <td class="id">{{$sec->id}}</td>
                            <td class="icon"><img width="50" src="{{asset('front/images/'.json_decode($sec->content)->icon)}}" alt=""></td>
                            <td class="heading">{{json_decode($sec->content)->heading}}</td>
                            <td class="description">{{json_decode($sec->content)->description}}</td>
                            <td class="d-flex">
                            <a href="javascript::void();" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary edit">Edit <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                           ...
                           <form method="POST" class="update-form" action="{{route('feature-sub-update')}}" enctype="multipart/form-data">
