    ...
    <div class="container-fluid">
        <div class="row second-chart-list third-news-update">
            <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
                <div class="card-body">
                    <form method="POST" action="{{url('admin/buy-update/'.$setting->id)}}" enctype="multipart/form-data">
                        @csrf
                      <div class="mb-3">
            ...
            <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
              <div class="card-body">
                  <h3>Add Step</h3>
                    <form method="POST" action="{{route('add-buy')}}" enctype="multipart/form-data">
                        @csrf
                      <div class="mb-3">
                        <label class="col-form-label">Heading</label>
                    ...
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <tr>
                            ...
                            <td ><span class="heading">{{json_decode($sec->content)->heading}}</span> <span>{{$loop->iteration}}</span></td>
                            <td class="subheading">{{json_decode($sec->content)->subheading}}</td>
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                           ...
                           <form method="POST" class="update-form" action="{{route('buy-sub-update')}}" enctype="multipart/form-data">
