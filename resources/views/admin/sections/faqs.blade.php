    ...
    <div class="container-fluid">
        <div class="row second-chart-list third-news-update">
            <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
                <div class="card-body">
                    <form method="POST" action="{{url('admin/faq-update/'.$setting->id)}}" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" type="email" name="email" value="{{json_decode($setting->content)->email}}" required>
                      </div>     
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                           ...
                           <form method="POST" class="update-form" action="{{route('faq-sub-update')}}" enctype="multipart/form-data">
